...
export default function PriceChart() {
    return (
        <div className="bg-card rounded-2xl border border-border p-6 h-[500px] flex flex-col relative overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex bg-muted/50 rounded-lg p-1">
                    ...
                    <button className="px-3 py-1 rounded-md text-xs font-medium bg-background shadow-sm text-foreground cursor-pointer transition-colors">
                        1W
                    </button>
                    <button className="px-3 py-1 rounded-md text-xs font-medium text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white cursor-pointer transition-colors">
                        1M
