        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <div className="flex items-center gap-4">
                <div className="flex -space-x-3">
                    <div className="w-12 h-12 rounded-full border-4 border-background-light dark:border-background-dark bg-black z-10 relative overflow-hidden shrink-0">
                        <Image
                            alt="SOL"
                            fill
                    ...
                    <div className="w-12 h-12 rounded-full border-4 border-background-light dark:border-background-dark bg-white z-0 relative overflow-hidden shrink-0">
                        <Image
                            alt="USDC"
                            fill
