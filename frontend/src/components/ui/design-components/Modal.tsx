...
export default function Modal({
    ...
    return createPortal(
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
            ...
            <div
                ref={modalRef}
                className={`relative w-full ${maxWidth} bg-white dark:bg-surface-dark rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800 transform transition-all max-h-[90vh] flex flex-col`}
            >
