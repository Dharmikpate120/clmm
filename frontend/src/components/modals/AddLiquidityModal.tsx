        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-muted/50 rounded-xl p-4 border border-border flex items-center justify-between cursor-pointer hover:border-primary transition-colors">
            ...
            <div className="space-y-4">
                ...
                <div className="h-24 bg-muted/30 rounded-xl border border-border relative overflow-hidden flex items-center justify-center">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="bg-muted/50 rounded-xl p-4 border border-border text-center hover:border-input transition-colors cursor-text group">
                        <div className="text-xs text-gray-500 mb-2">Min Price</div>
                        <div className="flex items-center justify-center gap-2">
                            <button
                                className="w-6 h-6 rounded bg-muted flex items-center justify-center hover:bg-muted/80 text-muted-foreground transition-colors"
                                onClick={() =>
                            ...
                            <input
                                className="bg-transparent text-center font-mono font-bold text-lg w-20 focus:outline-none text-foreground group-hover:text-primary transition-colors"
                                type="text"
                                value={minPrice}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-muted/50 p-4 rounded-xl border border-border focus-within:border-primary transition-colors">
                        <div className="flex justify-between mb-2">
                            ...
                            <span className="text-xs text-gray-500">
                                Bal: <span className="text-foreground">12.5</span>
                            </span>
                        </div>
                        <input
                            className="w-full bg-transparent text-xl font-mono font-bold focus:outline-none text-foreground"
                            placeholder="0.00"
                            type="text"
                        />
                    ...
                    <div className="bg-muted/50 p-4 rounded-xl border border-border focus-within:border-primary transition-colors">
                        <div className="flex justify-between mb-2">
                            ...
                            <span className="text-xs text-gray-500">
                                Bal: <span className="text-foreground">1,400.0</span>
                            </span>
                        </div>
                        <input
                            className="w-full bg-transparent text-xl font-mono font-bold focus:outline-none text-foreground"
