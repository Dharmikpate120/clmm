      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-muted/50 rounded-xl p-4 border border-border group hover:border-green-500/30 transition-colors">
            <div className="text-[10px] font-bold text-muted-foreground uppercase mb-2">Min Price</div>
            <div className="flex items-center justify-between">
              ...
              <input
                className="bg-transparent text-center font-mono font-bold text-lg w-full focus:outline-none"
                value={minPrice}
            ...
            <div className="text-[10px] font-mono text-muted-foreground mt-2 flex justify-center">Tick: {minTick}</div>
          </div>
          <div className="bg-muted/50 rounded-xl p-4 border border-border group hover:border-red-500/30 transition-colors">
            <div className="text-[10px] font-bold text-muted-foreground uppercase mb-2">Max Price</div>
            <div className="flex items-center justify-between">
              <button
                onClick={() => {
            ...
            <div className="text-[10px] font-mono text-muted-foreground mt-2 flex justify-center">Tick: {maxTick}</div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-muted/30 rounded-xl p-4 border border-border/50 group focus-within:border-primary transition-colors">
          ...
          <div className="text-[9px] text-muted-foreground mt-1 italic">
            Determines the required token amounts below
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div
            className={`bg-card p-4 rounded-xl border transition-all ${isAboveRange ? 'opacity-40 grayscale-[0.5]' : 'border-border shadow-sm'}`}
          >
            <div className="flex justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-sm">Token A</span>
              </div>
              <span className="text-[10px] font-bold text-muted-foreground uppercase">
                Bal: {userTokenAccounts.find((a) => a.token_mint_address === market.mint_address_a)?.balance || '0.00'}
              </span>
            </div>
          ...
          <div
            className={`bg-card p-4 rounded-xl border transition-all ${isBelowRange ? 'opacity-40 grayscale-[0.5]' : 'border-border shadow-sm'}`}
          >
            <div className="flex justify-between mb-3">
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 rounded-full shadow-sm relative overflow-hidden">
                ...
                <span className="font-bold text-sm">Token B</span>
              </div>
              <span className="text-[10px] font-bold text-muted-foreground uppercase">
                Bal: {userTokenAccounts.find((a) => a.token_mint_address === market.mint_address_b)?.balance || '0.00'}
              </span>
            </div>
            <div className="text-2xl font-mono font-bold text-foreground">
              {(() => {
